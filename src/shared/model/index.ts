...
export type { BaseQueryDTO } from './web/base-query-dto.model';
export type { DirectoryEntryDTO } from './web/directory-entry-dto.model';
...
export type { RegisteredAddressDTO } from './web/registered-address-dto.model';
